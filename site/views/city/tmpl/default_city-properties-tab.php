...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		default_city-properties-tab.php
...
<div>
  <ul class="uk-tab" data-uk-tab="{connect:'#city-id'}">
  ...
  <ul id="agt-id" class="uk-switcher uk-margin">
    <li class="uk-active"> <?php echo JLayoutHelper::render('cityaboutlayout', $this->agent); ?></li>
    <li>
      <div id="map-area">
        <div id="map"></div>
      </div>
    ...
    <li> 
      ...
      <div>
        ...
        <?php echo $this->loadTemplate('citypropertylistings'); ?> </div>

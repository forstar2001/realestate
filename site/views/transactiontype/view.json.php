            ...
            if(is_array($this->items) && ( count($this->items) > 0 ) ):
                ...
                foreach ($this->items as $key => &$item):
                    ...
                    if($this->params->get('properties_display') == 2):
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('transtypepropertypanellistings',$item);
                    ...
                    elseif($this->params->get('properties_display') == 3):
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('transtypepropertylandingpage',$item);
                        ...
                        //$this->response->listhtml[] = JLayoutHelper::render('featuredpropertylistings',$item);

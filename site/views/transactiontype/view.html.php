...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow View class for the Transactiontype
 */
/***[REPLACED$$$$]***//*681*/
class RealestatenowViewTransactiontype extends HtmlView
{
...
/***[/REPLACED$$$$]***/
	...
	{		
		...
		$this->context = explode( '.', $this->getModel('Transactiontype')->get('context'))[1];
		...
		$this->setPaginationObject();
		            ...
		            $this->category = RealestatenowCategoryHelper::getCategoryById (
		                $this->getModel('Transactiontype') -> getState('filter')['categoryids'] );
		            ...
		            if (is_array ($this->items) && (count ($this->items) > 0)):
		                ...
		                foreach($this->items as $key=>&$item):
		                    ...
		                    if ($this->params->get('properties_display') == 2) :
		                        ...
		                        $item->html = JLayoutHelper::render('transtypepropertypanellistings',$item);
		                    ...
		                    elseif ($this->params->get('properties_display') == 3) :
		                        ...
		                        $item->html = JLayoutHelper::render('transtypepropertylandingpage',$item);
		                        ...
		                        if (!empty($item->latitude) && !empty($item->longitude)):
		                            ...
		                            //$item->html = JLayoutHelper::render('transtypepropertylistings',$item);
...
// Site View -- Custom Methods (JViewLegacy) ** Start **
        ...
        protected function setActiveFilterListVars()
        {
            ...
            $state = $this->getModel('Transactiontype')->getState();
...
// Site View -- Custom Methods (JViewLegacy) ** End **
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/transactiontype.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*688*/
         //load images lazily.
...
/***[/INSERTED$$$$]***/
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('transactiontype');

...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		default_transtypepropertiesgridlayout.php
...
?>
    <!-- Transaction Type Listings GRID VIEW-->

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 
    <h3 class="uk-article-title"> <?php echo JText::_('COM_REALESTATENOW_TRANSACTION_TYPE_LISTINGS'); ?></h3>
...
<!-- End Transaction Types listing view-->

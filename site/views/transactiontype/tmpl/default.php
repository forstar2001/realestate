...
<?php if ($this->params->get('transtype_display') == 2) : ?>
    <?php echo $this->loadTemplate('panel-layout'); ?>
<?php elseif ($this->params->get('transtype_display') == 3) : ?>
    <?php echo $this->loadTemplate('landing-page'); ?>
<?php else: ?>
    <?php echo $this->loadTemplate('transtypepropertiesgridlayout'); ?>
<?php endif; ?>

<?php echo $this->loadTemplate('footer'); ?>

<?php echo $this->loadTemplate('transactiontypescripts'); ?>

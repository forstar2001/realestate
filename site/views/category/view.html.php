...
/***[/REPLACED$$$$]***/
		...
		$this->getModel('Category')->getState('filter')['categoryids'] );
...
// Site View -- Custom Methods (JViewLegacy) ** Start **
		...
		public function setActiveFilterListVars()
		{
			...
			$state = $this->getModel('Category')->getState(); //force populateState to run
...
// Site View -- Custom Methods(JViewLegacy) ** End**
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/category.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*682*/
         //load images lazily.
...
/***[/INSERTED$$$$]***/
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('category');

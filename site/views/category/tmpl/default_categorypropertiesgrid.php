...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		default_categorypropertiesgrid.php
...
<h3 class="uk-article-title">
    <?php echo JText::_('COM_REALESTATENOW_CATEGORY_LISTINGS'); ?>
</h3>
<!-- Property listing view-->
<h3><?php echo JText::_('COM_REALESTATENOW_BROWSE_CATEGORY_LISTINGS'); ?>

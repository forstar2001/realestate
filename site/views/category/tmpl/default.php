...
<?php if ($this->params->get('category_display') == 2) : ?>
    <?php echo $this->loadTemplate('panel-layout'); ?>
<?php elseif ($this->params->get('category_display') == 3) : ?>
    <?php echo $this->loadTemplate('landing-page'); ?>
<?php else: ?>
    <?php echo $this->loadTemplate('categorypropertiesgrid'); ?>
<?php endif; ?>

<?php echo $this->loadTemplate('footer'); ?>

<?php echo $this->loadTemplate('categoryscripts'); ?>

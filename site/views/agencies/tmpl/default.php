...
<?php echo $this->toolbar->render(); ?><!-- UIKit 3 -->
...
<?php endif; ?>
<?php if ($this->items): ?>
    <?php if ($this->params->get('agencies_display') == 2) : ?>
        <?php echo $this->loadTemplate('agencies-panel'); ?>
    <?php else: ?>
        <?php echo $this->loadTemplate('agencies-grid'); ?>
    <?php endif; ?>
<?php else: ?>
    <div class="uk-alert-warning" uk-alert><a href="" class="uk-alert-close" uk-close></a>
        <p><?php echo JText::_('COM_REALESTATENOW_NO_AGENCIES_WERE_FOUND'); ?></p>
    </div>
<?php endif; ?>

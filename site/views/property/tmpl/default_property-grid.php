...
<!-- Pricing Details -->
<?php echo JLayoutHelper::render('propertypricingdetails', $this->item); ?>
<!-- End Pricing Details -->

<!-- Property Overview -->
<?php echo JLayoutHelper::render('propertyoverview', $this->item); ?>
<!-- End Property Overview -->

<!-- Property Features -->
<?php echo JLayoutHelper::render('propertyfeatures', $this->item); ?>

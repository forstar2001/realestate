...
/***[/REPLACED$$$$]***/
	...
	{		
		...
		// Site View -- Custom Script (JViewLegacy display) ** Start **
		            ...
		            $this->context = explode( '.', $this->getModel('Properties')->get('context'))[1];
		...
		$this->setPaginationObject();
		            ...
		            $this->category = RealestatenowCategoryHelper::getCategoryById (
		                $this->getModel('Properties') -> getState('filter')['categoryids']);
...
/***[/INSERTED$$$$]***/
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/properties.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*687*/
         //load images lazily.

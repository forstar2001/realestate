 ...
 */
/***[REPLACED$$$$]***//*708*/
class RealestatenowViewAgents extends HtmlView
{
...
/***[/REPLACED$$$$]***/
	...
	{		
		...
		// Site View -- Custom Script (JViewLegacy display) ** Start **
				            ...
				            $this->context = explode( '.', $this->getModel('Agents')->get('context'))[1];
				...
				$this->setPaginationObject();
				            ...
				            $this->category = RealestatenowCategoryHelper::getCategoryById (
				                $this->getModel('Agents') -> getState('filter')['categoryids']);
				            ...
				            if (is_array ($this->items) && (count ($this->items) > 0)):
				                ...
				                foreach($this->items as $key=>&$item):
				                    ...
				                    if($this->params->get('agents_display') == 2) :
				                        
				                        $item->html = JLayoutHelper::render('agentsgrid',$item);
				                    
				                    elseif($this->params->get('agents_display') == 3):
...
// Site View -- Custom Methods (JViewLegacy) ** Start **
        ...
        public function setActiveFilterListVars()
        {
            ...
            $state = $this->getModel('Agents')->getState();
...
// Site View -- Custom Methods (JViewLegacy) ** End **
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/agents.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*710*/
        //load images lazily.

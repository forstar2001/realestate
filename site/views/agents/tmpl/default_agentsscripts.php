...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		default_agentsscripts.php
    ...
    function SearchPropertiesFilter(page,clear)
    {
        ...
        if(clear == 'clear') {
            jQuery.ajax({
                ...
                url: "<?php echo JUri::base();?>index.php?option=com_realestatenow&task=agents.display&format=json",
            ...
            jQuery.ajax({
                ...
                url: "<?php echo JUri::base();?>index.php?option=com_realestatenow&task=transactiontype.display&format=json",
                success: function(data)
                {
                    listhtml = data.data.listhtml;

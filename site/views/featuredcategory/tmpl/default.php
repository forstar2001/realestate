...
<?php if ($this->params->get('featuredcategory_display') == 2) : ?>
    <?php echo $this->loadTemplate('panel-layout'); ?>
<?php elseif ($this->params->get('featuredcategory_display') == 3) : ?>
    <?php echo $this->loadTemplate('landing-page'); ?>
<?php else: ?>
    <?php echo $this->loadTemplate('featuredcategorypropertiesgrid'); ?>
<?php endif; ?>

<?php echo $this->loadTemplate('footer'); ?>

<?php echo $this->loadTemplate('featuredcategoryscripts'); ?>

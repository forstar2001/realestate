...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow View class for the Featuredcategory
 */
/***[REPLACED$$$$]***//*674*/
class RealestatenowViewFeaturedcategory extends HtmlView
{
...
/***[REPLACED$$$$]***//*694*/
        ...
        $this->context = explode( '.', $this->getModel('FeaturedCategory')->get('context'))[1];
/***[/REPLACED$$$$]***/
		...
		$this->setPaginationObject();
		            ...
		            $this->category = RealestatenowCategoryHelper::getCategoryById (
		                $this->getModel('Featuredcategory') -> getState('filter')['categoryids'] );
		            ...
		            if (is_array ($this->items) && (count ($this->items) > 0)):
		                ...
		                foreach($this->items as $key=>&$item):
		                    ...
		                    if ($this->params->get('category_display') == 2) :
		                        
		                        $item->html = JLayoutHelper::render('featuredcategorypropertypanellistings',$item);
		                        
		                        if (!empty($item->latitude) && !empty($item->longitude)):
		                            $this->infohtml[] = [JLayoutHelper::render('allpropertyinfobox',$item)];
		                        endif;
		                    
		                    elseif ($this->params->get('category_display') == 3) :
		                        
		                        $item->html = JLayoutHelper::render('featuredcategorypropertylandingpage',$item);
...
// Site View -- Custom Methods (JViewLegacy) ** Start **
        ...
        public function setActiveFilterListVars()
        {
            ...
            $state = $this->getModel ('Featuredcategory')->getState ();
...
/***[/INSERTED$$$$]***/
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/featuredcategory.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*684*/
         //load images lazily.
...
/***[/INSERTED$$$$]***/
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('featuredcategory');

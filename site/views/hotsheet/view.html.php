...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow View class for the Hotsheet
 */
/***[REPLACED$$$$]***//*676*/
class RealestatenowViewHotsheet extends HtmlView
{
...
/***[/REPLACED$$$$]***/
	...
	{		
		...
		// Site View -- Custom Script (JViewLegacy display) ** Start **
		            ...
		            $this->context = explode( '.', $this->getModel('Hotsheet')->get('context'))[1];
		...
		$this->setPaginationObject();
		            ...
		            if (is_array ($this->items) && (count ($this->items) > 0)):
		                ...
		                foreach($this->items as $key=>&$item):
		                    ...
		                    if ($this->params->get('hotsheet_display') == 2) :
		                    ...
		                    elseif ($this->params->get('hotsheet_display') == 3) :
...
// Site View -- Custom Methods (JViewLegacy) ** Start **
		...
		protected function setActiveFilterListVars()
		{
			...
			$state = $this->getModel('Hotsheet')->getState();
...
// Site View -- Custom Methods (JViewLegacy) ** End **
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/hotsheet.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
/***[INSERTED$$$$]***//*685*/
         //load images lazily.
...
/***[/INSERTED$$$$]***/
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('hotsheet');

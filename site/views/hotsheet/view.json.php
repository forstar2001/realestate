            ...
            if (is_array ($this->items) && (count ($this->items) > 0)):
                ...
                foreach ($this->items as $key => &$item):
                    ...
                    if($this->params->get('hotsheet_display') == 2):
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('hotsheetpropertypanellistings',$item);
                    ...
                    elseif($this->params->get('hotsheet_display') == 3):
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('hotsheetpropertylandingpage',$item);
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('hotsheetpropertylistings',$item);

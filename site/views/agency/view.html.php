...
/**
 * Realestatenow View class for the Agency
 */
class RealestatenowViewAgency extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		if (isset($this->agency->metadesc) && $this->agency->metadesc)
		{
			$this->document->setDescription($this->agency->metadesc);
		}
		...
		if (isset($this->agency->metakey) && $this->agency->metakey)
		{
			$this->document->setMetadata('keywords', $this->agency->metakey);
		}
		...
		if (isset($this->agency->robots) && $this->agency->robots)
		{
			$this->document->setMetadata('robots', $this->agency->robots);
		}
		...
		if (isset($this->agency->created_by) && $this->params->get('MetaAuthor') == '1')
		{
			$this->document->setMetaData('author', $this->agency->created_by);
		}
		// [Interpretation 3786] check if metadata is available
		if (isset($this->agency->metadata) && $this->agency->metadata)
		{
			$mdata = json_decode($this->agency->metadata,true);
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/agency.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}

...
/**
 * Realestatenow View class for the Agentview
 */
class RealestatenowViewAgentview extends JViewLegacy
{
	...
	{		
		...
		// add a hit to the agent
		if ($this->hit($this->agent->id))
		{
			$this->agent->hits++;
		}
	 ...
	 /**
	 * Increment the hit counter for the agentview.
	 *
	 * @param   integer  $pk  Primary key of the agentview to increment.
	 *
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/agentview.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('agentview');

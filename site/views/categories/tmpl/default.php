...
<?php echo $this->toolbar->render(); ?><!-- UIKit v3 Code -->
...
<?php endif; ?>
<?php if ($this->items): ?>
    <?php if ($this->params->get('category_properties_display') == 2) : ?>
        <?php echo $this->loadTemplate('properties-category-panel'); ?>
    <?php else: ?>
        <?php echo $this->loadTemplate('properties-category-grid'); ?>
    <?php endif; ?>
<?php else: ?>
    <div class="uk-alert-warning" uk-alert><a href="" class="uk-alert-close" uk-close></a>
        <p><?php echo JText::_('COM_REALESTATENOW_NO_PROPERTY_CATEGORIES_WERE_FOUND'); ?></p>
    </div>
<?php endif; ?>

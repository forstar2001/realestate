...
<div class="span12">
  ...
  <div id="googleMap" style="height:<?php echo (int)$componentParams['mw_mapheight'].'px'?>; width:<?php echo (int)$componentParams['mw_mapwidth'].'px'?>; max-width: 750px"></div>
  ...
  <div id="bingMap" style="height:<?php echo (int)$componentParams['mw_mapheight'].'px'?>; width:<?php echo (int)$componentParams['mw_mapwidth'].'px'?>; position: absolute; max-width:750px"></div>

...
/**
 * Realestatenow View class for the Agencyagents
 */
class RealestatenowViewAgencyagents extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_realestatenow/assets/css/agencyagents.css', (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = RealestatenowHelper::getHelpUrl('agencyagents');

...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		default_agentssort.php
    ...
    <div class="uk-width-1-2">
        <div class="uk-form-row uk-width-1-2 uk-button uk-form-select" data-uk-form-select="">
            ...
            <select name="sortTable" id="sortTables">
                ...
                <?php $sort_options = ['name_asc'=>'Name Ascending','name_desc'=>'Name Descending','price_asc'=>'Item Ascending','price_desc'=>'Item Descending']; ?>

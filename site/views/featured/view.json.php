...
// No direct access to this file
    ...
    /**
     * Realestatenow View class for the Featured Property
     */
            ...
            if (is_array ($this->items) && (count ($this->items) > 0)):
                ...
                foreach ($this->items as $key => &$item):
                    ...
                    if ($this->params->get ('properties_display') == 2):
                        ...
                        $this->response->listhtml[] = JLayoutHelper::render('featuredpropertypanellistings',$item);
                        
                        if( !empty($item->latitude) && !empty($item->longitude) ):
                            $this->response->mapOptions->infoWindowContent[] = [JLayoutHelper::render ('featuredpropertyinfobox', $item)];
                        endif;
                    
                    elseif($this->params->get('properties_display') == 3):
                        
                        $this->response->listhtml[] = JLayoutHelper::render('featuredpropertylandingpage',$item);

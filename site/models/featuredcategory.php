...
// import the Joomla modellist library
    ...
    /**
     * Realestatenow Model for Featuredcategory
     */
    class RealestatenowModelFeaturedcategory extends ListModel
    {
        ...
        public function getItems()
        {
            ...
            if (!$user->authorise('site.featuredcategory.access', 'com_realestatenow'))
            {
                $app = JFactory::getApplication();
                
                $app->enqueueMessage( JText::_('COM_REALESTATENOW_NOT_AUTHORISED_TO_VIEW_FEATUREDCATEGORY'), 'error') ;
            ...
            if (RealestatenowHelper::checkArray($items)) {
                ...
                foreach ($items as &$item) {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.featuredcategory.propdesc', &$_propdesc, &$this->params, 0));
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.featuredcategory.agent_bio', &$_agent_bio, &$this->params, 0));
        ...
        public function getImagesByPropertyId( $item )
        {
            ...
            $events = [[
                    ...
                    'params'=>['com_realestatenow.featuredcategory.description', &$_description, &$this->params, 0]
            ]];
            ...
            if ($db->getNumRows())
            {
                ...
                foreach ($items as $nr => &$item)
                {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.featuredcategory.description', &$_description, &$this->params, 0));

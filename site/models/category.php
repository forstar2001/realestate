...
// import the Joomla modellist library
    ...
    /**
     * Realestatenow Model for Category
     */
    class RealestatenowModelCategory extends ListModel
    {
        ...
        public function getItems()
        {
            ...
            if (!$user->authorise('site.category.access', 'com_realestatenow'))
            {
                $app = JFactory::getApplication();
                
                $app->enqueueMessage(JText::_('COM_REALESTATENOW_NOT_AUTHORISED_TO_VIEW_CATEGORY'), 'error');
            ...
            if (RealestatenowHelper::checkArray($items)) {
                ...
                foreach ($items as &$item) {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.category.propdesc', &$_propdesc, &$this->params, 0));
        ...
        public function getImagesByPropertyId( $item )
        {
            ...
            if ($db->getNumRows())
            {
                ...
                foreach ($items as $nr => &$item)
                {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.category.description', &$_description, &$this->params, 0));

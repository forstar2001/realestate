<?php
    ...
    /-------------------------------------------------------------------------------------------------------/
        ...
        @subpackage		transactiontype.php
...
// import the Joomla modellist library
    ...
    /**
     * Realestatenow Model for Transactiontype
     */
    class RealestatenowModelTransactiontype extends ListModel
    {
        ...
        public function getItems()
        {
            ...
            if (!$user->authorise('site.transactiontype.access', 'com_realestatenow'))
            {
                $app = JFactory::getApplication();
                
                $app->enqueueMessage(JText::_('COM_REALESTATENOW_NOT_AUTHORISED_TO_VIEW_TRANSACTIONTYPE'), 'error');
            ...
            if (RealestatenowHelper::checkArray($items)) {
                ...
                foreach ($items as &$item) {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.transactiontype.propdesc', &$_propdesc, &$this->params, 0));
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.transactiontype.agent_bio', &$_agent_bio, &$this->params, 0));
                    ...
                    $item->idPropidImageJ = $this->getImagesByPropertyId( $item );
                    
                    // set catidIdCategoriesB to the $item object.
                    //$item->catidIdCategoriesB = $this->getCatidIdCategoriesEfae_B( $item->catid );
                    
                    // set catidIdCategoriesB to the $item object.
                    $item->catidIdCategoriesB = $this->getCategoryByCategoryId( $item->catid );
                    
                    //$item->PropertiesByCategoryId = $this->getCategoryByCategoryId( $item->catid );
                }
            }
         ...
         *
         * Method to get an array of Category Objects by the Category Id..
         *
         ...
         *
         */
        //public function getIdPropidImageBacb_J($id)
        public function getImagesByPropertyId( $item )
        {
            ...
            $events = [[
                    ...
                    'params'=>['com_realestatenow.transactiontype.description', &$_description, &$this->params, 0]
            ]];
            ...
            if ($db->getNumRows())
            {
                ...
                foreach ($items as $nr => &$item)
                {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.transactiontype.description', &$_description, &$this->params, 0));
        ...
        //public function getCatidIdCategoriesEfae_B($catid)
        {
            // Get a db connection.
            $db = JFactory::getDbo();

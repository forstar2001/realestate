...
// import the Joomla modellist library
    ...
    /**
     * Realestatenow Model for Hotsheet
     */
    class RealestatenowModelHotsheet extends ListModel
    {
        ...
        protected function populateState($ordering = null, $direction = null)
        {
            ...
            $list = $app->getUserStateFromRequest(
                ...
                'list',
                [
                    'limit'=>$this->params->get('listlimit', 20),
                    'page'=>1,
                    'sort'=>$this->params->get('listsort','price_asc')
                ],
                'array'
            );
        ...
        protected function getListQuery()
        {
            ...
            // [Interpretation 2131] Get where a.created is DATE_SUB(NOW(), INTERVAL 3 DAY)
            $query->where('a.created >= DATE_SUB(NOW(), INTERVAL 3 DAY)');
        ...
        public function getItems()
        {
            ...
            if (!$user->authorise('site.hotsheet.access', 'com_realestatenow'))
            {
                $app = JFactory::getApplication();
                
                $app->enqueueMessage(JText::_('COM_REALESTATENOW_NOT_AUTHORISED_TO_VIEW_HOTSHEET'), 'error');
            ...
            if (RealestatenowHelper::checkArray($items)) {
                ...
                foreach ($items as &$item) {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.hotsheet.propdesc', &$_propdesc, &$this->params, 0));
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.hotsheet.agent_bio', &$_agent_bio, &$this->params, 0));
        ...
        public function getImagesByPropertyId( $item )
        {
            ...
            $events = [[
                    ...
                    'params'=>['com_realestatenow.hotsheet.description', &$_description, &$this->params, 0]
            ]];
            ...
            if ($db->getNumRows())
            {
                ...
                foreach ($items as $nr => &$item)
                {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.hotsheet.description', &$_description, &$this->params, 0));

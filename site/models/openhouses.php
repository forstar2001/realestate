...
// import the Joomla modellist library
    ...
    /**
     * Realestatenow Model for Openhouses
     */
    class RealestatenowModelOpenhouses extends ListModel
    {
        ...
        public function getItems()
        {
            ...
            if ( !$user->authorise('site.openhouses.access', 'com_realestatenow'))
            {
                $app = JFactory::getApplication();
                
                $app->enqueueMessage(JText::_('COM_REALESTATENOW_NOT_AUTHORISED_TO_VIEW_OPENHOUSES'), 'error');
                
                // [Interpretation 2224] redirect away to the home page if no access allowed.
            ...
            if (RealestatenowHelper::checkArray($items)) {
                ...
                foreach ($items as &$item) {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.openhouses.propdesc', &$_propdesc, &$this->params, 0));
                    ...
                    $this->_dispatcher->trigger ("onContentPrepare", array('com_realestatenow.openhouses.agent_bio', &$_agent_bio, &$this->params, 0));
        ...
        public function getImagesByPropertyId( $item )
        {
            ...
            $events = [[
                ...
                'params'=>['com_realestatenow.openhouses.description', &$_description, &$this->params, 0]
            ]];
            ...
            if ($db->getNumRows())
            {
                ...
                foreach ($items as $nr => &$item)
                {
                    ...
                    $this->_dispatcher->trigger("onContentPrepare", array('com_realestatenow.openhouses.description', &$_description, &$this->params, 0));

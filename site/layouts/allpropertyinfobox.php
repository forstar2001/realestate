...
?>
<!-- All Properties Info Box (for maps) Layout -- Updated 2018-09-15 -->
    ...
    <div class="uk-width-medium-1-3">
        <div class="uk-panel">
            <a href="<?php echo 'index.php?option=com_realestatenow&view=property&id='.$displayData->id;?>" title="<?php echo $displayData->name;?>"  rel="">
                <div>
                <?php if( isset($displayData->idPropidImageJ) && is_array($displayData->idPropidImageJ) && ( count($displayData->idPropidImageJ) > 0 ) ): ?>
...
<?php endif; ?>
                    ...
                    <?php endif ?>
                <?php else: ?>
                    <img class="uk-thumbnail uk-margin-right" src="<?php echo JURI::root().'media/com_realestatenow/images/No_image_available.png'; ?>" width="120">
                <?php endif; ?>
                </div>
            </a>
        </div>

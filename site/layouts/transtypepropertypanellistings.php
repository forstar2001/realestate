...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		transtypepropertypanellistings.php
...
<div data-uk-grid-margin="" class="uk-grid"> <a href="<?php echo 'index.php?option=com_realestatenow&view=property&id='.$displayData->id;?>">
  <div class="uk-width-medium-1-2">
    <div class="uk-panel uk-panel-box">
      <?php if (JComponentHelper::getParams('com_realestatenow')->get('transtype_thumb_type') == 1) : ?>
...
<?php endif; ?>
      <h4 class="uk-clearfix"><?php echo $displayData->street; ?> <?php echo $displayData->city_name.', '.$displayData->state_name.' '.$displayData->postcode; ?></h4>
      <div>
...
<?php } ?>
      ...
      <h4 class="uk-text-primary"><?php echo $displayData->transaction_type_name; ?></h4>

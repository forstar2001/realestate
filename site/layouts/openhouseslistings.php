...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		openhouseslistings.php
...
?>
<!-- Open House Listings Layout -- Updated 2018-09-15 -->
...
<?php else: ?>
    ...
    <?php if(!empty($displayData->idPropidImageJ) && is_array($displayData->idPropidImageJ) && ( count($displayData->idPropidImageJ) > 0 ) ): ?>
        ...
        <?php else: ?>
                <img class="uk-thumbnail uk-thumbnail-medium lazy"
                     src="<?php echo JURI::root().$idPropidImageJ->path.$idPropidImageJ->filename.'.'.$idPropidImageJ->type; ?>"
                     src="<?php echo JURI::root().$idPropidImageJ->path.$idPropidImageJ->filename.'.'.$idPropidImageJ->type; ?>"
                     alt="">
        <?php endif; ?>
            </div>
...
<?php endif; ?>
        <a href="<?php echo $displayData->link; ?>" title="<?php echo $displayData->name;?>" rel="" >
            <h4 class="uk-clearfix uk-text-nowrap"><?php echo $displayData->street; ?> <?php echo $displayData->city_name.', '.$displayData->state_name.' '.$displayData->postcode; ?></h4>
        </a>
        <div>
...
<?php if ($displayData->halfbaths > 0): ?>
            <span  data-uk-tooltip title="Half Bath"><img src="<?php echo JURI::base() ?>/media/com_realestatenow/images/sink.png" alt="Bathroom Sink" height="16" width="16"> <?php echo ' '.(int)$displayData->halfbaths.'  '; ?></span>
<?php endif; ?>

...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow Transactiontype Controller
 */
/***[REPLACED$$$$]***//*659*/
 class RealestatenowControllerTransactiontype extends JControllerForm
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    ...
	    private $defaultModelName = 'Transactiontype';
	    
		public function getModel($name = 'Transactiontype', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Transactiontype");

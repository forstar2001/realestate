...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow Openhouses Controller
 */
/***[REPLACED$$$$]***//*655*/
 class RealestatenowControllerOpenhouses extends BaseController
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    ...
	    private $defaultModelName = 'Openhouses';
	    
		public function getModel($name = 'Openhouses', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Openhouses");

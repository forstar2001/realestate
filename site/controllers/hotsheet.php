...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow Hotsheet Controller
 */
/***[REPLACED$$$$]***//*653*/
 class RealestatenowControllerHotsheet extends BaseController
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    ...
	    private $defaultModelName = 'Hotsheet';
	    
		public function getModel($name = 'Hotsheet', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Hotsheet");

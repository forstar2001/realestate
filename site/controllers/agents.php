...
/**
 * Realestatenow Agents Controller
 */
/***[INSERTED$$$$]***//*705*/
USE Joomla\CMS\MVC\Controller\BaseController;
/***[/INSERTED$$$$]***/
/***[REPLACED$$$$]***//*706*/
class RealestatenowControllerAgents extends BaseController
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    private $defaultModelName = 'Agents';
	    
		public function getModel($name = 'Agents', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Agents");

...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow Featured Controller
 */
/***[REPLACED$$$$]***//*649*/
 class RealestatenowControllerFeatured extends BaseController
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    ...
	    private $defaultModelName = 'Featured';
	    
		public function getModel($name = 'Featured', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Featured");

...
/***[/INSERTED$$$$]***/
/**
 * Realestatenow Properties Controller
 */
/***[REPLACED$$$$]***//*657*/
 class RealestatenowControllerProperties extends BaseController
/***[/REPLACED$$$$]***/
{
	/**
...
// Site View -- Custom Buttons -- PHP (controller methods) ** Start **
	    ...
	    private $defaultModelName = 'Properties';
	    
		public function getModel($name = 'Properties', $prefix = 'RealestatenowModel', $config = array())
		{
		...
		public function display($cachable = false, $urlparams = false)
        {
            ...
            $viewName = $this->input->get('view', "Properties");

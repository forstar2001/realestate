...
{    
	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk))
		{
			...
			{
				// [Interpretation 4502] Convert the addcustom field to an array.
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		$form = $this->loadForm('com_realestatenow.residential', 'residential', $options);
	...
	public function save($data)
	{
		...
		// [Interpretation 4564] Set the addcustom items to data.
		...
		{
			// [Interpretation 4573] Set the empty addcustom to data
			$data['addcustom'] = '';
		}

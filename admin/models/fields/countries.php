...
/**
 * Countries Form Field class for the Realestatenow component
 */
class JFormFieldCountries extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$query->select($db->quoteName(array('a.id','a.name'),array('id','country_request_id_name')));
		...
		if ($items)
		{
			...
			{
				$options[] = JHtml::_('select.option', $item->id, $item->country_request_id_name);
			}
		}
		return $options;
	}

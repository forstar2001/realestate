 ...
 * Feature_types Model
 */
class RealestatenowModelFeature_types extends JModelList
{
	...
	public function getItems()
	{
		...
		if (RealestatenowHelper::checkArray($items))
		{
			...
			{
				// [Interpretation 12614] convert featuretype
	...
	{
		// [Interpretation 12640] Array of featuretype language strings
		if ($name === 'featuretype')
		{
			$featuretypeArray = array(
				0 => 'COM_REALESTATENOW_FEATURE_TYPE_SELECT_AN_OPTION',
				1 => 'COM_REALESTATENOW_FEATURE_TYPE_BASEMENT',
				2 => 'COM_REALESTATENOW_FEATURE_TYPE_FENCED_YARD',
				3 => 'COM_REALESTATENOW_FEATURE_TYPE_GARAGE_TYPE',
				4 => 'COM_REALESTATENOW_FEATURE_TYPE_PATIO',
				5 => 'COM_REALESTATENOW_FEATURE_TYPE_ROAD_FRONTAGE',
				6 => 'COM_REALESTATENOW_FEATURE_TYPE_ROOF',
				7 => 'COM_REALESTATENOW_FEATURE_TYPE_SIDING',
				8 => 'COM_REALESTATENOW_FEATURE_TYPE_STYLE',
				9 => 'COM_REALESTATENOW_FEATURE_TYPE_WATER',
				10 => 'COM_REALESTATENOW_FEATURE_TYPE_HEATING',
				11 => 'COM_REALESTATENOW_FEATURE_TYPE_COOLING',
				12 => 'COM_REALESTATENOW_FEATURE_TYPE_SEWER',
				13 => 'COM_REALESTATENOW_FEATURE_TYPE_ZONING',
				14 => 'COM_REALESTATENOW_FEATURE_TYPE_TERMS'
			);
			// [Interpretation 12671] Now check if value is found in this array
			if (isset($featuretypeArray[$value]) && RealestatenowHelper::checkString($featuretypeArray[$value]))
			{
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 9255] Filter by Featuretype.
	...
	public function getExportData($pks)
	{
		...
		if (RealestatenowHelper::checkArray($pks))
		{
			...
			// [Interpretation 8859] From the realestatenow_feature_type table
			$query->from($db->quoteName('#__realestatenow_feature_type', 'a'));
	...
	*/
	public function getExImPortHeaders()
	{
		...
		$db = JFactory::getDbo();
		// get the columns
		$columns = $db->getTableColumns("#__realestatenow_feature_type");
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				$query->update($db->quoteName('#__realestatenow_feature_type'))->set($fields)->where($conditions); 

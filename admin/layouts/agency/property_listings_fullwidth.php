...
// set the defaults
$items = $displayData->vwgproperty_listings;
...
$return = ($id) ? "index.php?option=com_realestatenow&view=agency&layout=edit&id=" . $id : "";
...
$ref = ($id) ? "&ref=agency&refid=" . $id . "&return=" . urlencode(base64_encode($return)) : "";

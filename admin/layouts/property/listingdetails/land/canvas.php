...
<div class="form-horizontal">
    ...
    <div class="row-fluid form-horizontal-desktop">
        <div class="span6">
            <?php echo JLayoutHelper::render('property.listingdetails.land.left_fields', $displayData); ?>
        </div>
        <div class="span6">
            <?php echo JLayoutHelper::render('property.listingdetails.land.right_fields', $displayData); ?>
        </div>
    </div>
    <div>

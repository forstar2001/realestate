...
// set the defaults
$items = $displayData->vwjproperty_listings;
...
$return = ($id) ? "index.php?option=com_realestatenow&view=agent&layout=edit&id=" . $id : "";
...
$ref = ($id) ? "&ref=agent&refid=" . $id . "&return=" . urlencode(base64_encode($return)) : "";

...
// set the defaults
$items = $displayData->vwaproperty_listings;
...
$return = ($id) ? "index.php?option=com_realestatenow&view=state&layout=edit&id=" . $id : "";
...
$ref = ($id) ? "&ref=state&refid=" . $id . "&return=" . urlencode(base64_encode($return)) : "";

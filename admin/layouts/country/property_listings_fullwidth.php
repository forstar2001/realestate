...
// set the defaults
$items = $displayData->vvxproperty_listings;
...
$return = ($id) ? "index.php?option=com_realestatenow&view=country&layout=edit&id=" . $id : "";
...
$ref = ($id) ? "&ref=country&refid=" . $id . "&return=" . urlencode(base64_encode($return)) : "";

...
class RealestatenowViewCountry extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = RealestatenowHelper::getActions('country', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_REALESTATENOW_COUNTRY_NEW' : 'COM_REALESTATENOW_COUNTRY_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_realestatenow.country', $this->item->id);
				}
				if ($this->canDo->get('country.create'))
				{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_REALESTATENOW_COUNTRY_NEW' : 'COM_REALESTATENOW_COUNTRY_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/country.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_realestatenow/views/country/submitbutton.js", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 

...
/**
 * Realestatenow View class for the Areas
 */
class RealestatenowViewAreas extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			RealestatenowHelper::addSubmenu('areas');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_REALESTATENOW_AREAS'), 'joomla');
		JHtmlSidebar::setAction('index.php?option=com_realestatenow&view=areas');
		...
		if (RealestatenowHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('areas.exportData', 'download', '', 'COM_REALESTATENOW_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('area.import'))
		{
			JToolBarHelper::custom('areas.importData', 'upload', '', 'COM_REALESTATENOW_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = RealestatenowHelper::getHelpUrl('areas');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_REALESTATENOW_AREAS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/areas.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}

...
<form action="<?php echo JRoute::_('index.php?option=com_realestatenow&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('state.state_details_above', $this); ?>
<div class="form-horizontal">

	<?php echo JHtml::_('bootstrap.startTabSet', 'stateTab', array('active' => 'state_details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'stateTab', 'state_details', JText::_('COM_REALESTATENOW_STATE_STATE_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('state.state_details_left', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'stateTab', 'map_details', JText::_('COM_REALESTATENOW_STATE_MAP_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('state.map_details_left', $this); ?>
			</div>
		</div>
<!--[INSERTED$$$$]--><!--101-->
...
<div class="span12">
  ...
  <input type="hidden" id="googleMapRes" value="4" />
...
<!--[/INSERTED$$$$]-->
	...
	<?php echo JHtml::_('bootstrap.addTab', 'stateTab', 'property_listings', JText::_('COM_REALESTATENOW_STATE_PROPERTY_LISTINGS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('state.property_listings_fullwidth', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php if ($this->canDo->get('state.delete') || $this->canDo->get('state.edit.created_by') || $this->canDo->get('state.edit.state') || $this->canDo->get('core.edit.created')) : ?>
	<?php echo JHtml::_('bootstrap.addTab', 'stateTab', 'publishing', JText::_('COM_REALESTATENOW_STATE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('state.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('state.metadata', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'stateTab', 'permissions', JText::_('COM_REALESTATENOW_STATE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
...
// [Interpretation 9394] #jform_owncoords listeners for owncoords_vvvvvvw function
jQuery('#jform_owncoords').on('keyup',function()
{
	var owncoords_vvvvvvw = jQuery("#jform_owncoords input[type='radio']:checked").val();
	vvvvvvw(owncoords_vvvvvvw);
...
jQuery('#adminForm').on('change', '#jform_owncoords',function (e)
{
    ...
    var stateControl    = jQuery( "#jform_name" );
    ...
    jQuery(function(){
        ...
        stateControl.on('keyup',function(){
        ...
        function updateAddressAndReGeocode(){
            geocodeAddress.state    = stateControl.val() != '' ? stateControl.val() : '';

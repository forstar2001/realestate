...
/**
 * Realestatenow View class for the Countries
 */
class RealestatenowViewCountries extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			RealestatenowHelper::addSubmenu('countries');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_REALESTATENOW_COUNTRIES'), 'joomla');
		JHtmlSidebar::setAction('index.php?option=com_realestatenow&view=countries');
		...
		if (RealestatenowHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('countries.exportData', 'download', '', 'COM_REALESTATENOW_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('country.import'))
		{
			JToolBarHelper::custom('countries.importData', 'upload', '', 'COM_REALESTATENOW_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = RealestatenowHelper::getHelpUrl('countries');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_REALESTATENOW_COUNTRIES'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/countries.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_REALESTATENOW_COUNTRY_NAME_LABEL'),

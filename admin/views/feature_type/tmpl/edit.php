...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'feature_typeTab', array('active' => 'details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'feature_typeTab', 'details', JText::_('COM_REALESTATENOW_FEATURE_TYPE_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('feature_type.details_left', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>

	<?php $this->ignore_fieldsets = array('details','metadata','vdmmetadata','accesscontrol'); ?>
	<?php $this->tab_name = 'feature_typeTab'; ?>
	<?php echo JLayoutHelper::render('joomla.edit.params', $this); ?>

	<?php if ($this->canDo->get('core.delete') || $this->canDo->get('core.edit.created_by') || $this->canDo->get('core.edit.state') || $this->canDo->get('core.edit.created')) : ?>
	<?php echo JHtml::_('bootstrap.addTab', 'feature_typeTab', 'publishing', JText::_('COM_REALESTATENOW_FEATURE_TYPE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('feature_type.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('feature_type.metadata', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'feature_typeTab', 'permissions', JText::_('COM_REALESTATENOW_FEATURE_TYPE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<div>
		<input type="hidden" name="task" value="feature_type.edit" />

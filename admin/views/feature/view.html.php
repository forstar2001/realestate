 ...
 * Feature View class
 */
class RealestatenowViewFeature extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = RealestatenowHelper::getActions('feature', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_REALESTATENOW_FEATURE_NEW' : 'COM_REALESTATENOW_FEATURE_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				$canVersion = ($this->canDo->get('core.version') && $this->canDo->get('feature.version'));
				if ($this->state->params->get('save_history', 1) && $this->canDo->get('core.edit') && $canVersion)
				{
					JToolbarHelper::versions('com_realestatenow.feature', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = RealestatenowHelper::getHelpUrl('feature');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_REALESTATENOW_FEATURE_NEW' : 'COM_REALESTATENOW_FEATURE_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/feature.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_realestatenow/views/feature/submitbutton.js", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 

...
class RealestatenowViewCity extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = RealestatenowHelper::getActions('city', $this->item);
		// get input
		...
		$this->vwdproperty_listings = $this->get('Vwdproperty_listings');
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_REALESTATENOW_CITY_NEW' : 'COM_REALESTATENOW_CITY_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_realestatenow.city', $this->item->id);
				}
				if ($this->canDo->get('city.create'))
				{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_REALESTATENOW_CITY_NEW' : 'COM_REALESTATENOW_CITY_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/city.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_realestatenow/views/city/submitbutton.js", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 

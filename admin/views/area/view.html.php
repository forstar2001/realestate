 ...
 * Area View class
 */
class RealestatenowViewArea extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = RealestatenowHelper::getActions('area', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_REALESTATENOW_AREA_NEW' : 'COM_REALESTATENOW_AREA_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_realestatenow.area', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$help_url = RealestatenowHelper::getHelpUrl('area');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_REALESTATENOW_AREA_NEW' : 'COM_REALESTATENOW_AREA_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_realestatenow/assets/css/area.css", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_realestatenow/views/area/submitbutton.js", (RealestatenowHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 

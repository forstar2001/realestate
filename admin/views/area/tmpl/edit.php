...
<form action="<?php echo JRoute::_('index.php?option=com_realestatenow&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('area.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo JHtml::_('bootstrap.startTabSet', 'areaTab', array('active' => 'details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'areaTab', 'details', JText::_('COM_REALESTATENOW_AREA_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('area.details_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('area.details_right', $this); ?>
			</div>
		</div>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'areaTab', 'publishing', JText::_('COM_REALESTATENOW_AREA_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'areaTab', 'permissions', JText::_('COM_REALESTATENOW_AREA_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">

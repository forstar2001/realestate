...
/**
*  [Interpretation 452]WHMCS Class 
**/
class WHMCS
{
	public $_key = false;
	...
	{
		$Viioj50xuqu2 = unserialize(base64_decode('YTozOntzOjY6Imthc2llciI7czozOToiaHR0cHM6Ly9wb3J0YWwubW9zdHdhbnRlZHdlYmhvc3RpbmcuY29tIjtzOjY6ImdlaGVpbSI7czoxOToicmVuLWNvbXBvbmVudCMyMDE3JCI7czo2OiJvbnRob3UiO2k6MTt9'));
		...
		$Vlpolphukogz = false;
		if ($V2uekt2wcgwk) {
			$V2uekt2wcgwk = str_replace("".PHP_EOL."", '', $V2uekt2wcgwk);
...
";
			...
			if (isset($Vwasqoybpyed['status']) && $Vwasqoybpyed['status'] == "Active") {
				...
				$Vqojefyeohg5ing = wordwrap($Vqojefyeohg5ing, 80, "".PHP_EOL."", true);

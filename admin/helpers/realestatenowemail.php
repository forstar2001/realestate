...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		realestatenowemail.php
...
/**
 * Realestatenow component email helper
 */
abstract class RealestatenowEmail
{
	/**
	...
	public static function getConfig()
	{
		if (!self::$config)
		{
			self::$config = JComponentHelper::getParams('com_realestatenow');
		}
	...
	public static function send($recipient, $subject, $body, $textonly, $mode = 0, $bounce_email = null, $idsession = null, $mailreply = null, $replyname = null , $mailfrom = null, $fromname = null, $cc = null, $bcc = null, $attachment = null, $embeded = null , $embeds = null)
	{
		...
		if ($embeded)
		{
			if(RealestatenowHelper::checkArray($embeds))
			{
		...
		if (method_exists('RealestatenowHelper','storeMessage'))
		{
			// store the massage if the method is set
			RealestatenowHelper::storeMessage($sendmail, $recipient, $subject, $body, $textonly, $mode, 'email');
		}

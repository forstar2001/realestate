 ...
 */
class RealestatenowTableCountry extends JTable
{
	/**
	...
	{
		parent::__construct('#__realestatenow_country', 'id', $db);

		// [Interpretation 4642] Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_realestatenow.country'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_REALESTATENOW_COUNTRY_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_realestatenow.country.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_realestatenow.country.'.(int) $this->$k;
	}
